...
# Read and examine
class.schedule = read.csv("nrm-489689-detailed-schedule-05JUN2025.csv", fileEncoding = "cp1252", stringsAsFactors = FALSE)
...
kbl(class.schedule, format = "html") %>%
  ...
  pack_rows("DAY 13: Wednesday, 23JUL - DEADHORSE TO MARION CREEK", 122, 132, background = "grey80") %>%
  pack_rows("DAY 14: Thursday, 24JUL - MARION CREEK TO FAIRBANKS AND DEPARTURE", 133, 140, background = "grey80") 
